...
export function CateringForm({ notice }: Props) {
  ...
  return (
    <>
      ...
      {notice && (
        <Reveal>
          <div className="mb-6 flex items-start gap-3 rounded-2xl border border-brand-orange/25 bg-brand-warm p-5 text-sm leading-relaxed text-brand-brown">
