...
function fallbackDish(
  slug: string,
  names: [nl: string, fr: string, en: string],
  category: string,
  priceCents: number,
...
const FALLBACK_DISHES: Dish[] = [
  ...
  fallbackDish("harira", ["Harira", "Harira", "Harira"], "bstilla", 500),
  fallbackDish("thee", ["Thee", "Thé", "Mint tea"], "drink", 250),
  fallbackDish("koffie", ["Koffie", "Café", "Coffee"], "drink", 300),
  fallbackDish("frisdranken", ["Frisdranken", "Boissons fraîches", "Soft drinks"], "drink", 250),
  fallbackDish("thee-koekjes", ["Thee + koekjes", "Thé + biscuits", "Tea + cookies"], "sweet", 550),
  fallbackDish("koekje-pack", ["Koekje pack", "Pack de biscuits", "Cookie pack"], "sweet", 600),
];
